...
const Payment = () => {
  ...
  return (
    <main className="max-w-xl md:mx-auto p-10 text-black text-center m-10 bg-gradient-to-tr to-[#E6E6E6] from-[#FFF0F0] shadow-[8px_8px_0_0_#FE3D02] border-black border-2">
      <div className="mb-10">
